...
import { CONTENT_SPACING, MAX_ZOOM_FACTOR, SAFE_AREA_PADDING } from '../global/constants';
...
export function CameraPage(/*{ navigation }: Props*/)/*: React.ReactElement*/ {
  ...
  const devicelist = Camera.getAvailableCameraDevices();
 ...
 /* const onMediaCaptured = useCallback(
  ...
  console.log("supportsCameraFlipping: " + supportsCameraFlipping);
  ...
  if(devicelist != null)
  {
    ...
    for (let i in devicelist) {
      if(i<2)
      console.log("ID: ", devicelist[i].position);
    }
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.rightButtonRow}>
        <Text style={styles.text}>flip:{supportsCameraFlipping?"yes":"no"}</Text>
